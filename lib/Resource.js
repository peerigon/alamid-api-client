...
Resource.prototype.get = function (query) {
    var url = pathToUrl(this.urlSchemas.get, query);

    obj.without(query, this.variables.get);

    return this.api.get(url, query);
};

Resource.prototype.getById = function (query) {
    var url;
    ...
    url = pathToUrl(this.urlSchemas.getById, query);
...
Resource.prototype.save = function (query, obj) {
    ...
    method = this.idProperty in obj? "put" : "post";
